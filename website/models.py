...
class SubSkillType(models.Model):
    type = models.CharField(max_length=100, null=True, blank=True)
...
class Skill(models.Model):
    ...
    sub_skill_type = models.ForeignKey('SubSkillType', on_delete=models.CASCADE, null=True, blank=True)
    ...
    def __str__(self):
        return f"{self.skill_type} - {self.sub_skill_type} - {self.skill_name}"
